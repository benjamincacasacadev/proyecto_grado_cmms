{{Form::open(array('action'=>array('ClientsController@destroy',code($cliente->id)),'method'=>'delete', 'onsubmit'=>'btnSubmitDelete.disabled = true; return true;'))}}
    ...
    <div class="modal-body text-center py-4">
        ...
        @else
            ...
            <h3>No puede eliminar el cliente <b>{{ $cliente->nombre }}</b> </h3>
            <div class="text-muted">
                El cliente tiene {{ $count }} @if( $count == 1) activo asociado. @else activos asociados. @endif
            </div>
        @endif
