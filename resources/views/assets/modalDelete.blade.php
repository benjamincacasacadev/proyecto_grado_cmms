{{Form::open(array('action'=>array('StAssetsController@destroy',code($asset->id)),'method'=>'delete', 'onsubmit'=>'btnSubmitDelete.disabled = true; return true;'))}}
    ...
    <div class="modal-body text-center py-4">
        @if ($count == 0)
            ...
            <div class="text-muted">
                ¿Está seguro de eliminar el cliente <b>{{ $asset->cod }}</b>?
            </div>
        @else
            ...
            <h3>No puede eliminar el cliente <b>{{ $asset->cod }}</b> </h3>
            <div class="text-muted">
                El cliente tiene {{ $count }} @if( $count == 1) orden de trabajo asociada. @else órdenes de trabajo asociados. @endif
            </div>
        @endif
