! function (e, t) {
    ...
    function n(e, t, n) {
        ...
        if (n && "undefined" != typeof document) {
            var o, i = !0 === r.prepend ? "prepend" : "append",
                a = !0 === r.singleTag,
                l = "string" == typeof r.container ? document.querySelector(r.container) : document.getElementsByTagName("head")[0];
            if (a) {
                var f = e.indexOf(l); - 1 === f && (f = e.push(l) - 1, t[f] = {}), o = t[f] && t[f][i] ? t[f][i] : t[f][i] = s()
            } else o = s();
            65279 === n.charCodeAt(0) && (n = n.substring(1)), o.styleSheet ? o.styleSheet.cssText += n : o.appendChild(document.createTextNode(n))
        }
    ...
    var r = function () {
            ...
            return e.prototype.success = function (e, t, n) {
                ...
                this.renderOptions({}), this.render({
                    notification: o
                })
            }, e.prototype.createNotification = function (e, t, n, r) {
                if ("object" == typeof e ? (e = (r = e).type, t = r.message, n = r.title) : "object" == typeof t ? (t = (r = t).message, n = r.title) : "object" == typeof n && (n = (r = n).title), void 0 === t) throw new Error("message option is required");
                return {
                    type: e || "info",
                    message: t,
                    title: n,
                ...
                var t = this,
                    ...
                    r = Array.isArray(n) ? this.options : Object.assign({}, this.options, n);
                this.applyDarkMode();
                var o = function () {
                ...
                return n || ((n = document.createElement("div")).classList.add("fl-main-container"), n.dataset.position = e.position, Object.keys(e.style).forEach((function (t) {
                ...
                r.classList.add("fl-container"), this.appendNotification(e, r, n), this.renderProgressBar(r, n), this.handleClick(r)
            }, e.prototype.appendNotification = function (e, t, n) {
                "bottom" === n.direction ? e.append(t) : e.prepend(t), n.rtl && t.classList.add("fl-rtl"), setTimeout((function () {
                    t.classList.add("fl-show")
                }), 100)
            }, e.prototype.removeNotification = function (e) {
                var t = e.parentElement;
                e.classList.remove("fl-show"), e.addEventListener("transitionend", (function () {
                ...
                if (t.timeout && !(t.timeout <= 0)) {
                    ...
                    var i = 1e3 / t.fps,
                        ...
                        l = function () {
                            ...
                            r.style.width = "".concat(o, "%"), o <= 0 && (clearInterval(f), n.removeNotification(e))
                        },
                ...
                var e = [].concat(this.options.darkMode),
                    ...
                    n = e[1],
                    r = void 0 === n ? ".dark" : n,
                    o = ".fl-main-container .fl-container.fl-flasher {background-color: rgb(15, 23, 42);color: rgb(255, 255, 255);}";
                o = "media" === t ? "@media (prefers-color-scheme: dark) {".concat(o, "}") : "".concat(r, " ").concat(o);
                var i = document.createElement("style");
                i.type = "text/css", i.appendChild(document.createTextNode(o)), document.head.appendChild(i)
                ...
                if (t) return (new DOMParser).parseFromString(e, "text/html").body.firstChild;
        ...
        o = new(function () {
            function e() {
                this.defaultHandler = "theme.flasher", this.factories = new Map, this.themes = new Map
            }
            return e.prototype.success = function (e, t, n) {
                this.flash("success", e, t, n)
            }, e.prototype.info = function (e, t, n) {
                ...
                if (!t) throw new Error('Unable to resolve "'.concat(e, '" notification factory, did you forget to register it?'));
                return t
            }, e.prototype.renderOptions = function (e) {
                var t = this;
                ...
                var t = this;
                e = this.resolveResponse(e), this.addStyles(e.styles, (function () {
                    t.addScripts(e.scripts, (function () {
                        t.renderOptions(e.options), t.renderEnvelopes(e.envelopes, e.context)
                    }))
                }))
                ...
                var n = this;
                if (0 !== e.length)
                    if (null === document.querySelector('link[href="'.concat(e[0], '"]'))) {
                        var r = document.createElement("link");
                        r.setAttribute("href", e[0]), r.setAttribute("type", "text/css"), r.setAttribute("rel", "stylesheet"), r.onload = function () {
                ...
                var n = this;
                if (0 !== e.length)
                    if (null === document.querySelector('script[src="'.concat(e[0], '"]'))) {
                        var r = document.createElement("script");
                        r.setAttribute("src", e[0]), r.setAttribute("type", "text/javascript"), r.onload = function () {
                ...
                e.forEach((function (e) {
                    e.context = Object.assign({}, e.context || {}, t), e.handler = n.resolveHandler(e.handler);
                    var o = n.create(e.handler);
                    n.isQueueable(o) ? (r.get(e.handler) || o.resetQueue(), o.addEnvelope(e), r.set(e.handler, o)) : o.render(e)
                })), r.forEach((function (e) {
                    return e.renderQueue()
                }))
            }, e.prototype.isQueueable = function (e) {
                return "function" == typeof e.addEnvelope && "function" == typeof e.renderQueue
            }, e.prototype.resolveResponse = function (e) {
                var t = this;
                return e.envelopes = e.envelopes || [], e.options = e.options || {}, e.scripts = e.scripts || [], e.styles = e.styles || [], e.context = e.context || {}, Object.entries(e.options).forEach((function (n) {
                    var r = n[0],
                        o = n[1];
                    e.options[r] = t.parseOptions(o)
                })), e.envelopes.forEach((function (n) {
                    n.handler = t.resolveHandler(n.handler), n.notification.options = t.parseOptions(n.notification.options || {}), t.pushStyles(e, n.handler)
                })), e
                ...
                var o = e.match(/^function(?:.+)?(?:\s+)?\((.+)?\)(?:\s+|\n+)?{(?:\s+|\n+)?((?:.|\n)+)}$/m);
                if (!o) return e;
                var i = null !== (r = null === (t = o[1]) || void 0 === t ? void 0 : t.split(",").map((function (e) {
                        return e.trim()
                    }))) && void 0 !== r ? r : [],
                    a = o[2];
                return new(Function.bind.apply(Function, n(n([void 0], i, !1), [a], !1)))
            }, e.prototype.pushStyles = function (e, t) {
                var n;
                t = t.replace("theme.", "");
                var r = (null === (n = this.themes.get(t)) || void 0 === n ? void 0 : n.styles) || [];
                e.styles = e.styles.concat(r).filter((function (e, t, n) {
                    return n.indexOf(e) === t
                }))
            }, e.prototype.resolveHandler = function (e) {
                return e = e || this.defaultHandler, ["flasher", "theme", "template"].includes(e) && (e = "theme.flasher"), e = e.replace("template.", "theme.")
    ...
    return o.addTheme("flasher", {
        render: function (e) {
            var t, n = e.notification;
            return '<div class="fl-flasher fl-' + n.type + '"><div class="fl-content"><div class="fl-icon"></div><div><strong class="fl-title">' + (null !== (t = n.title) && void 0 !== t ? t : n.type) + '</strong><span class="fl-message">' + n.message + '</span></div></div><span class="fl-progress-bar"></span></div>'
        }
    }), o
}));
